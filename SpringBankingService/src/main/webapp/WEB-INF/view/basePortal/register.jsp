...
<html>
	<head>
		...
		<title>OBS Connect Registration</title>
							...
							<div class="card-body p-4 p-md-5">
								...
								<div class="bs-stepper py-3 w-50 mx-auto">
									...
									<div class="bs-stepper-header m-auto mb-3" role="tablist">
										...
										<div class="line"></div>
										<div class="step" data-target="#registration">
											<button type="button" class="step-trigger" role="tab" aria-controls="registration" id="registrationTrigger">
												<span class="bs-stepper-circle">2</span><span class="bs-stepper-label">Registration</span>
											</button>
										</div>
									</div>
									<div class="bs-stepper-content p-0">
										...
										<div id="verification" class="content" role="tabpanel" aria-labelledby="verificationTrigger">
											<div class="container">
												...
												<form name="verifyRegistration" action="register/verification" method="post" class="needs-validation"
										...
										<div id="registration" class="content" role="tabpanel" aria-labelledby="registrationTrigger">
											<div class="container">
												...
												<form name="registration" action="register/save" method="post" class="needs-validation" novalidate onsubmit="submitForm(this)">
													...
													<div class="float-end">
														<button class="btn btn-danger btn-lg px-4" type="submit">Register</button>
													</div>
												</form>
											</div>
										</div>
