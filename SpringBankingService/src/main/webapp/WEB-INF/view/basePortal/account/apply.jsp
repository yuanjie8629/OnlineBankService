...
<div class="container w-75 p-2">
	...
	<div id="stepper" class="bs-stepper py-3">
		...
		<div class="bs-stepper-content p-0">
			<form:form name="applyAccount" modelAttribute="application" action="" method="post" enctype="multipart/form-data" class="needs-validation" novalidate="true" onsubmit="submitForm()">
							...
							<div class="row g-4">
								<spring:bind path="identityDoc">
									<div class="col-12">
										...
										<form:input class="step-3 form-control${status.error ? ' is-invalid' : ''}" type="file" path="identityDoc" accept="application/pdf" onchange="getIdentityDocLink(this)" required="required"/>
...
<script>
	...
	let form = document.forms['applyAccount'];
	function nextStep() {
