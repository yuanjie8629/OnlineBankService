...
<c:url var="url" value="/account/apply/" />
		...
		<div class="modal-content  p-3">
			...
			<div class="modal-body px-5 py-4">
				<div class="row g-3">
					...
					<div class="col-12">
						<button class="btn btn-lg btn-outline-danger w-100" data-bs-target="#existCustModal" data-bs-toggle="modal">Existing
							Customer</button>
					</div>
				</div>
			</div>
...
<form name="existCustForm" action="<c:url value="/account/checkCust" />" method="post" class="needs-validation"
	novalidate>
