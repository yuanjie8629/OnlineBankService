		...
		<div class="container">
			...
			<div class="offcanvas offcanvas-end" id="navbarToggler" aria-labelledby="offcanvasNavbar">
				<ul id="header-nav" class="navbar-nav">
					<li id="about-us" class="nav-item active"><a class="nav-link" aria-current="page" href="<c:url value="/about-us" />">About Us</a></li>
						...
						<div class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-inline">
								...
								<ul class="d-flex justify-content-between flex-wrap p-0">
									<li><a class="dropdown-item" href="<c:url value="/account?type=saving" />">Account</a></li>
									<li><a class="dropdown-item" href="<c:url value="/credit-card" />">Credit Card</a></li>
									<li><a class="dropdown-item" href="<c:url value="/loan?type=personal" />">Loan</a></li>
								</ul>
							</div>
						</div>
					</li>
					<li id="track-application" class="nav-item"><a class="nav-link" aria-current="page" href="<c:url value="/track-application" />"> Track My Application </a></li>
