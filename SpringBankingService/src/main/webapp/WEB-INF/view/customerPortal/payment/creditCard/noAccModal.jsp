		...
		<div class="modal-content p-4">
			...
			<div class="modal-header flex-column">
				...
				<h3 class="mt-4 text-capitalize">
					No Account for Credit Card Payment.
				</h3>
			</div>
			<div class="modal-body m-auto px-5 text-center">
				<p>Sorry, you don't have any account to pay for the credit card.</p>
				<p>Kindly approach to the nearest OBS Bank for the credit card payment.</p>
			</div>
