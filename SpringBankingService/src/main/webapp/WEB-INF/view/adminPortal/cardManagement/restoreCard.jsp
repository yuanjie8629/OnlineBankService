...
<!-- Delete Modal -->
<div class="modal fade" id="restoreCardModal" tabindex="-1" aria-labelledby="restoreCardModal" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-confirm">
		<div class="modal-content p-3 text-center">
			...
			<div class="modal-body p-0">
				<p>Do you really want to restore the card?</p>
			</div>
...
<script>
let restoreModal = document.getElementById('restoreCardModal')
restoreModal.addEventListener('show.bs.modal', event => {
  ...
  restoreBtn.href = "<c:url value="/admin/card-management/restore/" />" + id;
})
</script>