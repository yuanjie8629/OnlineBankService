...
<!-- Approve Modal -->
<form name="cardAppFurtherAction" action="further-action" method="post" class="needs-validation" novalidate>
	<input type="hidden" name="id" value="${cardApp.id}" />
		...
		<div class="modal-dialog modal-lg modal-dialog-centered modal-confirm">
			<div class="modal-content p-4">
				...
				<div class="modal-header flex-column">
					...
					<h3 class="mt-4 text-capitalize">Further Action on Card Application</h3>
				</div>
