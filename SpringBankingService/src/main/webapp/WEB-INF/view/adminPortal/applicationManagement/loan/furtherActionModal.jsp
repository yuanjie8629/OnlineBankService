...
<!-- Approve Modal -->
<form name="loanAppFurtherAction" action="further-action" method="post" class="needs-validation" novalidate>
		...
		<div class="modal-dialog modal-lg modal-dialog-centered modal-confirm">
			<div class="modal-content p-4">
				...
				<div class="modal-header flex-column">
					...
					<h3 class="mt-4 text-capitalize">Further Action on Loan Application</h3>
				</div>
