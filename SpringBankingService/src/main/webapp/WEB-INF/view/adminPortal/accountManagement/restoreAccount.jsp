...
<!-- Delete Modal -->
<div class="modal fade" id="restoreAccModal" tabindex="-1" aria-labelledby="restoreAccModal" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-confirm">
		<div class="modal-content p-3 text-center">
			...
			<div class="modal-body p-0">
				<p>Do you really want to restore the account?</p>
			</div>
...
<script>
let restoreModal = document.getElementById('restoreAccModal')
restoreModal.addEventListener('show.bs.modal', event => {
  ...
  restoreBtn.href = "<c:url value="/admin/account-management/restore/" />" + id;
})
</script>