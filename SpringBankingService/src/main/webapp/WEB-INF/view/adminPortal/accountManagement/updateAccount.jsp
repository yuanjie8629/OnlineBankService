				...
				<form name="updateAccount">
					<fieldset class="row mb-3">
						...
						<div class="col-md-9">
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="type" value="saving"> <label class="form-check-label" for="saving">Saving</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="type" value="current"> <label class="form-check-label" for="current">Current</label>
							</div>
						</div>
					</fieldset>
					<div class="mb-3">
						<label for="title" class="form-label">Title</label> <input class="form-control" name="title" placeholder="Enter Account Title">
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<div class="input-group">
							<input class="form-control" type="number" name="interestRate" placeholder="Enter Interest Rate" min="0" max="100" step="0.01">
					...
					<div class="mb-3">
						...
						<div class="input-group">
							<input class="form-control" type="number" name="minAmount" placeholder="Enter Mininum Deposit Amount" min="0" step="0.01">
				...
				<div class="row g-4 justify-content-center align-items-center h-100">
					<div class="col-10 col-lg-6">
						<div class="card card-hover">
							<img id="thumbnail" src="${URLUtils.getBasePath()}/resources/images/PreviewImage.png" class="card-img-top" alt="savingAcc">
							<div class="card-body">
