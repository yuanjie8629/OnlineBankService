...
<div class="container mt-4">
	<div>
	<h3>Welcome To OBS Admin Portal, ${user.name}</h3>
		...
		<div class="row g-4 m-auto text-center" style="width: 80%;">
				...
				<div class="card card-btn h-100">
					<div class="card-body">
						<div class="p-2 m-auto" style="max-width: 120px;">
							<img src="<c:url value="/resources/images/adminPortal/home/AccountManagement.png" />" alt="accMgmt" class="img-fluid rounded img-btn" />
						</div>
						<div class="my-2">
			...
			<div class="col-12 col-md-6 col-lg-4">
				<div class="card card-btn h-100">
					<div class="card-body">
						<div class="p-2 m-auto" style="max-width: 120px;">
							<img src="<c:url value="/resources/images/adminPortal/home/CardManagement.png" />" alt="cardMgmt" class="img-fluid rounded img-btn" />
						</div>
						<div class="my-2">
			...
			<div class="col-12 col-md-6 col-lg-4">
				<div class="card card-btn h-100">
					<div class="card-body">
						<div class="p-2 m-auto" style="max-width: 120px;">
							<img src="<c:url value="/resources/images/adminPortal/home/LoanManagement.png" />" alt="loanMgmt" class="img-fluid rounded img-btn" />
						</div>
						<div class="my-2">
			...
			<div class="col-12 col-md-6 col-lg-4">
				<div class="card card-btn h-100">
					<div class="card-body">
						<div class="p-2 m-auto" style="max-width: 120px;">
							<img src="<c:url value="/resources/images/adminPortal/home/CustomerManagement.png" />" alt="customerMgmt" class="img-fluid rounded img-btn" />
						</div>
						<div class="my-2">
			...
			<div class="col-12 col-md-6 col-lg-4">
				<div class="card card-btn h-100">
					<div class="card-body">
						<div class="p-2 m-auto" style="max-width: 120px;">
							<img src="<c:url value="/resources/images/adminPortal/home/ApplicationManagement.png" />" alt="applicationMgmt" class="img-fluid rounded img-btn" />
						</div>
						<div class="my-2">
			...
			<div class="col-12 col-md-6 col-lg-4">
				<div class="card card-btn h-100">
					<div class="card-body">
						<div class="p-2 m-auto" style="max-width: 120px;">
							<img src="<c:url value="/resources/images/adminPortal/home/ProfileManagement.png" />" alt="profileMgmt" class="img-fluid rounded img-btn" />
						</div>
						<div class="my-2">
