		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarNavDropdown">
				<ul id="header-nav" class="navbar-nav text-center">
					<li id="home" class="nav-item active"><a class="nav-link" aria-current="page"
						href="<c:url value="/admin/home" />">Home</a></li>
					<li id="account-management" class="nav-item dropdown"><a class="nav-link" role="button"
					...
					<li id="card-management" class="nav-item dropdown"><a class="nav-link" role="button" data-bs-toggle="dropdown"
						aria-expanded="false">Card Management</a>
						<div class="dropdown-menu w-100">
							<span class="dropdown-menu-arrow d-none d-lg-block"></span>
							<ul class="list-unstyled">
					...
					<li id="loan-management" class="nav-item dropdown">
						<a class="nav-link" role="button" data-bs-toggle="dropdown" aria-expanded="false">Loan Management</a>
						<div class="dropdown-menu w-100">
							<span class="dropdown-menu-arrow d-none d-lg-block"></span>
							<ul class="list-unstyled">
					...
					<li id="application-management" class="nav-item dropdown">
						...
						<div class="dropdown-menu w-100">
							<span class="dropdown-menu-arrow d-none d-lg-block"></span>
							<ul class="list-unstyled">
								<li><a class="dropdown-item" href="<c:url value="/admin/application-management/account" />">Account Application</a></li>
								<li><a class="dropdown-item" href="<c:url value="/admin/application-management/card" />">Card Application</a></li>
								<li><a class="dropdown-item" href="<c:url value="/admin/application-management/loan" />">Loan Application</a></li>
							</ul>
						</div>
					</li>
					<li id="profile-management" class="nav-item"><a class="nav-link"
						href="<c:url value="/admin/profile-management" />">Profile Management</a></li>
				</ul>
			</div>
		</div>
	</nav>
