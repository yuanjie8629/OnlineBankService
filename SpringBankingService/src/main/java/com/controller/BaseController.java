...
public class BaseController {
	...
	public String contactUs(@Valid @ModelAttribute("feedback") Feedback feedback, BindingResult br, Model m,
		...
		ra.addFlashAttribute("msg", "Failed to submit your feedback. Please ensure all information are valid.");
		return "contact-us";
	}
